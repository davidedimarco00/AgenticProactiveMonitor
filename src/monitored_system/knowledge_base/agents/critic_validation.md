...
- it calls application delay a network fault while ICMP/TCP network timing remains normal;
- it calls network delay an application-only fault while link RTT clearly rises;
...
- compare packet-level latency with application-level latency.
